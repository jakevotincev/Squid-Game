            ...
            <div className="App">
                <header className="App-header">
                    ...
                    {this.state.criteriaMsgIsReceived === true &&
                        <div className="ManagerMessagee" id="managerMessagee" align="center">
                            ...
                            <p>
                                ...
                                <input type="text" id="decline" name="decline" placeholder="Введите причину отказа"
                    ...
                    {this.state.showInterruptionBtn === true &&
                        <button type="submit" onClick={this.interuptPlayersSelection}>Прервать отбор анкет
                            участников</button>
                    }
