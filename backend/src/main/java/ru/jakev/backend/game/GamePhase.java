...
public enum GamePhase {
    ...
    ROUND_PREPARE_AND_TRAINING_WAITING("ROUND_PREPARE_AND_TRAINING_WAITING"),
    ROUND_PREPARE_AND_TRAINING("ROUND_PREPARE_AND_TRAINING"),
    GAME("GAME"),
    CLEANING("CLEANING"),
    SHOW_RESULTS_WAIT("SHOW_RESULTS_WAIT"),
    END("END");
