...
values (1, 'Как называется еврейский Новый год?',
        '{"Ханука":false,"Йом Кипур":false,"Кванза":false,"Рош ха-Шана":true}', 1, 1, 'GAME_QUIZ')
on conflict do nothing;

insert into quiz (id, question, answers, game_id, round_id, quiz_type)
values (2, 'Сколько синих полос на флаге США?', '{"0":true,"3":false,"6":false,"13":false}', 1, 1, 'GAME_QUIZ')
on conflict do nothing;

insert into quiz (id, question, answers, game_id, round_id, quiz_type)
values (3, 'Кто из этих персонажей не дружит с Гарри Поттером?',
        '{"Драко Малфой":true,"Рон Уизли":false,"Гермиона Грейнджер":false,"Невил Долгопупс":false}', 1, 1, 'GAME_QUIZ')
on conflict do nothing;

insert into quiz (id, question, answers, game_id, round_id, quiz_type)
values (4, 'Вам нужно приготовить блины. Для этого вам понадобится: молоко, мука, сахар, ?. Назовите недостающий ингредиент.',
